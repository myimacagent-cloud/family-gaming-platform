      ...
      <div style={{ background: 'rgba(255,255,255,0.95)', borderRadius: 12, padding: 10 }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(10, 1fr)', gap: 4 }}>
          {Array.from({ length: 100 }, (_, i) => 100 - i).map((n) => {
            ...
            const isP2 = p2Pos === n;
            return (
              <div key={n} style={{ minHeight: 28, borderRadius: 6, background: '#f8fafc', border: '1px solid #cbd5e1', display: 'grid', placeItems: 'center', fontSize: 11, fontWeight: 700, position: 'relative' }}>
                {n}
                {(isP1 || isP2) && (
